...
class App extends Component {
  constructor(props) {
    ...
    this.state = {
      data: [
        ...
        {name: 'Ann L.', salary: 5000, increase: true, rise: false, id: 3},
        {name: 'Oleg X.', salary: 1000, increase: false, rise: false, id: 4}
      ],
      term: '',
      filter: 'all'
    }
  ...
  render() {
    ...
    return (
      <div className="app">
        <AppInfo emploeesCount={data.length}
                 increaseCount={increased.length}/>
